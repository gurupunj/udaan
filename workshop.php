...
<div class="container forfixhead gap">
...
<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" style="padding-top: 20px;">
    <div class="hovereffect">
        <img class="img-responsive" src="image/workshop2.jpg" alt="">
        <div class="overlay">
        	 <h2>QUADCOPTER Workshop</h2>
        	 <a class="info" data-toggle="modal" data-target="#REGISTER">REGISTER</a>
...
<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" style="padding-top: 20px;">
    <div class="hovereffect">
        <img class="img-responsive" src="image/g.jpg" alt="">
        <div class="overlay">
           <h2 > RC Plane Workshop</h2>
           <a class="info" data-toggle="modal" data-target="#REGISTER">REGISTER</a>
...
<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" style="padding-top: 20px;">
    <div class="hovereffect">
        <img class="img-responsive" src="image/workshop3.jpg" alt="">
        <div class="overlay">
           <h2  style="font-weight: bold; font-family: Choc ICG;">TriCopter Workshop</h2>
           <a class="info" data-toggle="modal" data-target="#REGISTER">REGISTER</a>
...
<div class="modal fade" id="REGISTER">
    <div class="modal-dialog">
      <div style="background-color:#413b3880; " class="modal-content">
        
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal"><span  style="background-color: white; color: black" class="glyphicon glyphicon-remove "></span></button>
              <h1 style="color: white; font-family: Choc ICG;" align="center">REGISTER FOR EVENT </h1>
        </div>
        ...
        <div class="modal-header">
            ...
            <div class="form-group">
               <fieldset > 
      <legend><b>UDAAN&nbsp;&nbsp;AERO-MODELING </b></legend>
      <form role="form" align="center" method="post" action="display.php">
         <table >
           <tr>
             <th>Name *</th></tr>
             <tr>
             <td><input class="i" type="text" name="t1" placeholder="YOUR NAME" required /></td>
           </tr>
           ...
           <tr>
             <th style="padding-top: 10px;padding-bottom: 10px">Gender</th>
    ...
    <option value="F">FEMALE</option>
           ...
           <tr>
             <td><input class="i"  type="text" placeholder="+XX XXXXX XXXXX" name="t3" pattern="[6-9]{1}[0-9]{9}" required /></td>
           </tr>
           <tr><th><br></th></tr>
           ...
           <tr>
             <th>Workshop *</th>
             <td> <select name="t4">
    <option value="rc">RC Plane</option>
    <option value="quad">QUADCOPTER</option>
    <option value="tri">Tri Copter</option>
  </select></td>
           </tr>
           <tr><th><br></th></tr>
           ...
           <tr>
             <td><input class="i" type="email" placeholder="UDAAN@gmail.com" name="t5" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" required></td>
           </tr>
...
<tr><th><br></th></tr>
           ...
           <tr>
             ...
             <td><input type="date"  name="t6" max="2003-1-1" required><br><br></td>
           </tr>
           <tr><th><br></th></tr>
           ...
           <tr>
             <td><input class="i" type="text" name="t7" placeholder="POORNIMA GROUP OF INSTITUTIONS"  /></td>
           </tr>
           <tr>
             <th>ADDRESS *</th>
             </tr>
          
                                   <tr><td>  <textarea class="i" name="t8" required></textarea></td>
                                </tr>
          
           
           <tr>
             <td colspan="3" style="padding-top:20px; "><input type="submit" class="submitbtn" value="Register" /></td>
           </tr>
         </table>
      </form>
    </fieldset>
